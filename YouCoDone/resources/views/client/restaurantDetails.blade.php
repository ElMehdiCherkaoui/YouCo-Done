        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 animate-slide-in hover-scale">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Make a Reservation</h3>
                        ...
                        @auth
                            <form action="" method="POST" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select name="time" required
                                        ...
                                        @for ($hour = 11; $hour <= 22; $hour++)
                                            ...
                                            <option value="{{ sprintf('%02d:30', $hour) }}">{{ sprintf('%02d:30', $hour) }}
                                            </option>
                                        @endfor
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="special_requests" rows="3" placeholder="Any special requests or dietary requirements?"
                                ...
                                <button type="submit"
                                    class="w-full py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition duration-200">
                                    Reserve Now
                                </button>
                            </form>
                        @else
                            <div class="text-center py-6">
                                <p class="text-gray-600 mb-4">Sign in to make a reservation</p>
                                <a href="{{ route('login') }}"
                                    class="w-full py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg font-semibold hover:shadow-lg transition duration-200 block">
                                    Sign In
                                </a>
                            </div>
                        @endauth
