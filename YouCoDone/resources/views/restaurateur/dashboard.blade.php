...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 animate-slide-in">
            ...
            <p class="text-xl text-gray-600">Welcome back, {{ auth()->user()->name }}! Here's your restaurant overview</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 animate-slide-in" style="animation-delay: 0.25s;">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="#" class="text-orange-600 hover:text-orange-700 font-semibold text-sm">View All →</a>
                    </div>

                    <div class="space-y-4">
                        @for($i = 0; $i < 5; $i++)
                        <div class="flex items-center justify-between p-4 rounded-xl hover:bg-gray-50 transition duration-200">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Restaurant {{ ($i % 3) + 1 }} · {{ rand(2, 6) }} people</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="font-semibold text-gray-900">{{ date('M d, Y', strtotime('+' . $i . ' days')) }}</p>
                                <p class="text-sm text-gray-600">{{ ['5:00 PM', '6:00 PM', '7:00 PM', '8:00 PM'][rand(0, 3)] }}</p>
                            </div>
                            <div>
                                <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full {{ ['bg-green-100 text-green-800', 'bg-yellow-100 text-yellow-800', 'bg-blue-100 text-blue-800'][rand(0, 2)] }}">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 animate-slide-in" style="animation-delay: 0.3s;">
                    ...
                    <div class="h-64 flex items-end justify-between space-x-2">
                        ...
                        <div class="flex-1 flex flex-col items-center">
                            <div class="w-full bg-gradient-to-t from-orange-500 to-red-500 rounded-t-lg transition-all duration-300 hover:opacity-80" style="height: {{ rand(30, 100) }}%"></div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 animate-slide-in" style="animation-delay: 0.35s;">
                    ...
                    <div class="space-y-3">
                        <a href="" class="flex items-center justify-between p-4 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl hover:shadow-lg transform hover:-translate-y-0.5 transition duration-200">
                ...
                <!-- Tips -->
                <div class="bg-gradient-to-br from-purple-500 to-indigo-500 rounded-2xl shadow-sm p-6 text-white animate-slide-in" style="animation-delay: 0.45s;">
